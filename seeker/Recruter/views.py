...
class Navbarview(View):
       def get(self,request):
        ...
        #      my_string = ' '.join([str(element) for element in session_uname]) 
             print("1111111", session_uname)  
             if (session_uname == None):
                     return redirect("login")
             else:                     
               return render(request,"Navbar.html",{"username": session_uname})                  
...
class GetCompanyPro_ListJobview(View):
        ...
        #       print("1111",my_string)
                ...
                s_obj=Signup_User.objects.filter(username= session_uname).values()
                print(s_obj[0]['name'])
                ...
                return render(request,"List_job.html",{"jobs":obj,"company":obj2,"username":session_uname})  
...
def Viewapplication(request,job_code):
        ...
        if (loggedin_user == None):
                ...
                print("uu",u)     
                # my_string = ' '.join([str(element) for element in session_uname])
                return render(request,"View_applications.html",{"obj":obj,"username": session_uname }) 
...
class Respond_Application_View (View):
        ...
        #     print(request.GET)
            ...
            return render(request,"Status-Application.html",{"obj":obj,"username": session_uname})
...
class Company_Profileview(View):
        def get(self,request):
                ...
                if (loggedin_user == None):
                        ...
                        session_uname=request.session.get('loggedinuser')
                        #     my_string = ' '.join([str(element) for element in  loggedin_user])
                        user_details=Compnay_Profile.objects.filter(username= session_uname).values()
                        print(user_details[0]['company_name'])
                        return render(request,"company_profile.html",{"job":user_details,"username": session_uname}) 
